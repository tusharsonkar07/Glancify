...
export default function Header({ onSearch, onClearSearch, isSearching }) {
  ...
  return (
    /*
      safe-area-inset-top pushes the inner content DOWN below the
      notch / Dynamic Island / status bar so nothing is obscured.
      The background colour fills that gap automatically.
    */
    <header
